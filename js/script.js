    ...
    async function initCarousel(carouselId, productIds) {
      const swiperWrapper = document.querySelector(`#es-durex #${carouselId} .swiper-wrapper`);
    ...
    async function initAllCarousels() {
      await initCarousel('es-carousel-1', ['181324', '145013','6551','175311']);
      await initCarousel('es-carousel-2', ['181324', '181327','181321', '181322']);
      await initCarousel('es-carousel-3', ['6542', '6540','148076', '145013']);
      await initCarousel('es-carousel-4', ['6551', '137090','148078', '53027','64533','13302','148077']);
      await initCarousel('es-carousel-5', ['175311','175310','175309', '175312','175313','175312','148800']);
    }
